...
import type { WorkspaceLike } from "@hello-harness/extensions";
...
function createGitTool(workspace: WorkspaceLike, name: string, description: string, args: string[]): Tool {
  return {
    name,
    description,
...
export function createGitTools(workspace: WorkspaceLike): Tool[] {
  return [
    createGitTool(
      workspace,
      "git_status",
