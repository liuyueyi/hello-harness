...
- ✅ **[20 · Write Tool](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/20-write-tool)** 
  - —— 给 Agent 装上 write 工具，把内容写进代码库；在 read 的 workspace 边界之上，把「有副作用的写」变成可观察、可校验的受控动作
  - —— 源码GitTag: [v20-write](https://github.com/liuyueyi/hello-harness/releases/tag/v20-write)
- ✅ **[21 · Edit Tool](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/21-edit-tool)** 
  - —— 给 Agent 装上 edit 工具，用 search / replace 精准改动一小段代码；理解为什么整文件覆写不够好
  - —— 源码GitTag: [v21-edit](https://github.com/liuyueyi/hello-harness/releases/tag/v21-edit)
- ✅ **[22 · Bash Tool](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/22-bash-tool)** 
  - —— 给 Agent 装上 bash 工具，跑命令、看输出、验结果；在 cwd / timeout / stdout / stderr / exitCode 的护栏里，第一次面对「能造成真实破坏」的高风险工具
  - —— 源码GitTag: [v22-bash](https://github.com/liuyueyi/hello-harness/releases/tag/v22-bash)
- ✅ **[23 · Workspace](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/23-workspace)** 
  - —— 新增 Workspace 抽象，把 root / resolve / read / write / exists 收拢到一个对象；四个文件工具不再裸碰文件系统，护栏从「复制粘贴」变为「单一入口」
  - —— 源码GitTag: [v23-workspace](https://github.com/liuyueyi/hello-harness/releases/tag/v23-workspace)
- ✅ **[24 · System Prompt](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/24-system-prompt)** 
  - —— 把散装在工具规则里的「怎么干活」提炼成方法论（先观察、再修改、修改后验证、不要猜文件内容），Agent 从「会调用工具」升级成「有章法地干活」
  - —— 源码GitTag: [v24-system-prompt](https://github.com/liuyueyi/hello-harness/releases/tag/v24-system-prompt)
- ✅ **[25 · CLI](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/25-cli)** 
  - —— 把仓库变成产品：`hello` 一条命令打开任意项目目录并运行 Coding Agent；从 `pnpm dev -- --tools ...` 收敛成人话入口
  - —— 源码GitTag: [v25-cli](https://github.com/liuyueyi/hello-harness/releases/tag/v25-cli)
- ✅ **[26 · Multi-turn Session](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/26-multi-turn-session)** 
  - —— 把多轮对话正式化为 Session：一个带 id 的 AgentContext，跨轮持有对话历史与工具上下文，为下一章的落盘续跑做准备
  - —— 源码GitTag: [v26-session](https://github.com/liuyueyi/hello-harness/releases/tag/v26-session)
- ✅ **[27 · Session 持久化](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/27-session-persistence)** 
  - —— 把 Session 存进磁盘 `.sessions/session-id.json`，每一轮对话结束自动落盘，让「这场对话」从内存里活到硬盘上
  - —— 源码GitTag: [v27-session-store](https://github.com/liuyueyi/hello-harness/releases/tag/v27-session-store)
- ✅ **[28 · Resume](https://liuyueyi.github.io/hello-harness/zh/tutorials/stage-3-hello-coding-agent/28-resume)** 
  - —— `hello --resume <会话id>`：从 `.sessions/` 读回昨天的一场对话，让 Agent 继续干活；Stage 3 收官，Coding Agent 毕业总览
  - —— 源码GitTag: [v28-resume](https://github.com/liuyueyi/hello-harness/releases/tag/v28-resume)
